  ...
  return <>
    <section className="studio-hero">
      ...
      <div className="section-shell studio-hero-inner">
        ...
        <h1>Ideas claras.<br/>Diseño que<br/><em>deja huella.</em></h1>
